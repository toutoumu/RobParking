			...
			while (iterator.hasNext()) {
				...
				if (queryCondition != null) {
					...
					if (queryCondition.getValue() != null && !"".equals(queryCondition.getValue())) {
						...
						String placeholder = queryCondition.getField().indexOf(".") != -1 ? queryCondition.getField()
		...
		if (queryConditions != null && queryConditions.size() > 0) {
			...
			while (iterator2.hasNext()) {
				...
				if (queryCondition != null) {
					if (queryCondition.getValue() != null && !"".equals(queryCondition.getValue())) {
						// 将占位符中的.替换成_
						queryCondition.setField(queryCondition.getField().indexOf(".") != -1 ? queryCondition
								.getField().replace(".", "_") : queryCondition.getField());
